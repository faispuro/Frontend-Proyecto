      ...
      >
        <div className="inventario-header">
          ...
          >
            <i
              className={`fa-solid ${
                mostrarDashboard ? "fa-eye-slash" : "fa-eye"
              }`}
            ></i>
                      ...
                      {productosPaginados.map((producto) => (
                        <tr key={producto.id}>
                          ...
                          <td className="stock-cell">
                            <span
                              className={`stock-badge ${obtenerClaseStock(
                                producto.cantidad
                              )}`}
                            >
                              {producto.cantidad}
                          ...
                          <td>
                            <span
                              className={`stock-estado ${obtenerClaseStock(
                                producto.cantidad
                              )}`}
                            >
                          ...
                          <td className="botones-fila">
                            ...
                            <button
                              onClick={() =>
                                manejarEliminar(producto.id, producto.nombre)
                              }
